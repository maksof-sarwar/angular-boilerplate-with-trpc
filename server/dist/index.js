...
var require_bytes = __commonJS({
  "node_modules/.pnpm/bytes@3.0.0/node_modules/bytes/index.js"(exports, module2) {
    "use strict";
...
var require_compressible = __commonJS({
  "node_modules/.pnpm/compressible@2.0.18/node_modules/compressible/index.js"(exports, module2) {
    "use strict";
    var db = require_mime_db();
...
var require_on_headers = __commonJS({
  "node_modules/.pnpm/on-headers@1.0.2/node_modules/on-headers/index.js"(exports, module2) {
    "use strict";
...
var require_compression = __commonJS({
  "node_modules/.pnpm/compression@1.7.4/node_modules/compression/index.js"(exports, module2) {
    "use strict";
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/TRPCError-6a1653a4.mjs
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/codes-c924c3db.mjs
function invert(obj) {
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/index-f91d720c.mjs
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/config-cd32070b.mjs
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/index.mjs
...
var isAuth = middleware(async ({ ctx, next }) => {
  return next({
    ctx: {
      session: null
    }
...
var protectedProcedure = t.procedure.use(isAuth);
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/transformTRPCResponse-1153b421.mjs
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/contentType-53e30af8.mjs
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/resolveHTTPResponse-67085326.mjs
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/batchStreamFormatter-fc1ffb26.mjs
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/contentType-3194ed5f.mjs
function createNodeHTTPContentTypeHandler(contentTypeHandler) {
  return () => contentTypeHandler;
}

// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/adapters/node-http/content-type/json/index.mjs
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/nodeHTTPRequestHandler-2503a117.mjs
...
// node_modules/.pnpm/@trpc+server@10.38.1/node_modules/@trpc/server/dist/adapters/express.mjs
...
var Server = class {
  ...
  async init(app) {
    ...
    this.setupRouter(router2);
    server.listen(PORT, () => {
      console.log(`\u{1F680} [server] is running on port : ${PORT}`);
    });
  }
  setupRouter(router2) {
    router2.get("/logs", (_, res) => {
      const file = (0, import_path.join)(__dirname, "..", "logs.txt");
      return (0, import_fs.existsSync)(file) ? res.sendFile(file) : res.sendStatus(404);
    });
    router2.get("/health", async (_, res) => {
      return res.status(200).send({ status: "OK" });
    });
    router2.get("/docs", (req, res) => {
    ...
    router2.use(
      ...
      createExpressMiddleware({
        router: appRouter,
        createContext,
        onError: process.env.NODE_ENV === "development" ? ({ error, req }) => {
          console.error(
...
@trpc/server/dist/nodeHTTPRequestHandler-2503a117.mjs:
  (* istanbul ignore if -- @preserve *)
*/
